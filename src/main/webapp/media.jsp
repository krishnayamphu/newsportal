    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Media Management
                        </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card card-primary">
                            <!-- form start -->
                            <form class="form-inline" method="post" enctype="multipart/form-data" action="/newsportal/media">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label class="pr-1">File to upload </label>
                                        <input type="file" class="" name="upfile">
                                    </div>
                    ...
                    <c:forEach var="image" items="${images}">
                        <div class="col mb-4">
                            <div class="card h-100">
                                <div class="card-body">
                                    <a href="#!">
                                        <img src="${pageContext.request.contextPath}/uploads/${image}" class="card-img-top">
                                    </a>
                                </div>
                            </div>
                        </div>
